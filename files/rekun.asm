...
push cs
pop ds
mov ax,word[cs:files]
mov word[cs:rap_w],ax
mov ax,word[cs:files+2]
mov word[cs:rap_h],ax
mov bx,word[cs:rap_w]
mul bx
mov word[cs:rap_m],ax
mov word[cs:next_c],00
call __clear_screen
...
inc word[cs:next_c]
mov ax,word[cs:rap_m]
cmp word[cs:next_c],ax
je _end
jmp next_char
